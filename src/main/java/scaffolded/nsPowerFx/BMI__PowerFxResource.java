...
import org.drools.demo.JSR223DMNRuntime;
import org.eclipse.microprofile.openapi.annotations.tags.Tag;
import org.kie.kogito.dmn.rest.DMNJSONUtils;
import org.kie.kogito.dmn.rest.KogitoDMNResult;

@Tag(name = "demo", description = "For use with JSR223")
@Path("/demo/BMI_PowerFx")
public class BMI__PowerFxResource {

    @javax.inject.Inject()
    JSR223DMNRuntime application;
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.getDecisionModel("nsPowerFx", "BMI_PowerFx");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("nsPowerFx", "BMI_PowerFx", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("BMI_PowerFx") + ".dmn_nologic")));
    }
